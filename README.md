...
データセット・学習ステップ数・レイヤー数・シードはUIから変更可能です。
...
1. **データ準備**: 選択したデータセット（市区町村名 約1,756件 / 呪文名 約196件）を読み込み
2. **トークン化**: 文字レベルでトークン化
